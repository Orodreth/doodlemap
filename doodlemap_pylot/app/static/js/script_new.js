$(document).ready(function(){
  ...
  var id = $('#initial_id').val();
  var latitude = $('#initial_latitude').val();
  var longitude = $('#initial_longitude').val();
  ...
  new_search_bar.addListener('place_changed', function () {
    ...
    // $('#initial_location').val(address);
    // $('#initial_id').val(id);
    // $('#initial_latitude').val(latitude);
    // $('#initial_longitude').val(longitude);
    ...
    service.getDetails(request={ placeId:new_place.place_id }, function callback(new_place, status, id) {
        if (status == google.maps.places.PlacesServiceStatus.OK) {
            marker.addListener('click', function () {
                ////////////// ADDING TO INFO TAB ///////////////
                var photoString = "";
                for (var i=0; i < new_place.photos.length; i++){
                  photoString += "<img src="+new_place.photos[i].getUrl({'maxWidth': 500, 'maxHeight': 500}) + ">";
                }
    ...
    // console.log("this is not working:", $("#form_hidden").serialize())
    // console.log("initial location", $('#initial_location').val())

    // $("#form_hidden").trigger("submit");

    var url = "/welcome/refresh/" + address + "/" + id + "/" + latitude + "/" + longitude;
    // console.log(url);
    ...
    //   $("#form_hidden").submit(function(e){
    //     // e.preventDefault();
    //     // console.log("please work", $(this).serialize());
